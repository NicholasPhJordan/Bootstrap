...
void main() {
	//Light 0 
	vec3 kNormal0 = normalize(fNormal.xyz);
	...
	float lambertTerm0 = dot(kNormal0, -iNormal0);
	...
	vec3 reflectionNormal0 = reflect(iNormal0, kNormal0);
	...
	//Light 1 
	vec3 kNormal1 = normalize(fNormal.xyz);
	...
	//Calculate diffuse color
	float lambertTerm1 = dot(kNormal1, -iNormal1);
	...
	vec3 reflectionNormal1 = reflect(iNormal1, kNormal1);
